...
{
    // Because Polygon is Shape so class Polygon inherits class Shape
    class Polygon : Shape
    {
        ...
        // Initialize the Polygon with n vertices
        protected void init()
        {
        ...
        // Draw a polygon with n vertices
